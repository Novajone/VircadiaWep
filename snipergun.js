...
(function() { 
    ...
    Gun.prototype = {
        ...
        leftHandMouseEquipAnimation: function() {
            ...
            result.leftHandPosition = Vec3.multiply(offset, {x: 0.25, y: 1.0, z: 0.0});
            ...
            result.leftHandRotation = Quat.multiply(newRotation, Quat.fromPitchYawRollDegrees(90, 0, -90));
        ...
        rightHandMouseEquipAnimation: function() {
            ...
            result.rightHandPosition = Vec3.multiply(offset, {x: 0.25, y: 1.0, z: 0.0});
